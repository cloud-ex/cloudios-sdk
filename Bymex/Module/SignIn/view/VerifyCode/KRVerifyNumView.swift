...
class KRVerifyNumView: UIView {
    ...
    lazy var cursor: CAShapeLayer = {
        ...
        shapeLayer.fillColor = UIColor.ThemeLabel.colorHighlight.cgColor
...
extension KRVerifyNumView {
    ...
    func setBottomLineFocus(isFocus: Bool) {
        if isFocus {
            lineView.backgroundColor = UIColor.ThemeView.mySign
        } else {
