...
class KRSwitch: UIControl {
    var bgOffColor:UIColor = UIColor.ThemeLabel.colorDark
    var bgOnColor:UIColor = UIColor.ThemeView.highlight25
    var switchOnColor:UIColor = UIColor.ThemeLabel.colorHighlight
    var switchOffColor:UIColor = UIColor.ThemeLabel.colorMedium
    var isOn:Bool = false
    ...
    func config(){
        ...
        self.frame = CGRect(x: 0, y: 0, width: 36, height: 20)
