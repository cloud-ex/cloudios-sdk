...
/**
 ...
 - None:  不显示
 */
public enum KRYAxisShowPosition {
...
/// - dash: 虚线
/// - solid: 实线
public enum KRAxisReferenceStyle {
    case none
...
public struct KRYAxis {
    ...
    /// 辅助线样式
    public var referenceStyle: KRAxisReferenceStyle = .dash(color: UIColor(white: 0.2, alpha: 1), pattern: [5])
 ...
 *  X轴数据模型
 */
public struct KRXAxis {
    
    public var tickInterval: Int = 6           //间断显示个数
    
    /// 辅助线样式
    public var referenceStyle: KRAxisReferenceStyle = .none
}
