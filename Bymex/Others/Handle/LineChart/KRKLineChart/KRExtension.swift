...
public extension String {
    ...
    /**
     ...
     - returns:
     */
    func kr_sizeWithConstrained(_ font: UIFont,
...
public extension UIColor {
    ...
    /**
     ...
     - returns:
     */
    class func kr_hex(_ hex: UInt, alpha: Float = 1.0) -> UIColor {
...
public extension Date {
     ...
     * @result                时间
     */
    static func kr_getTimeByStamp(_ timestamp: Int, format: String) -> String {
        var time = ""
        if (timestamp == 0) {
            return ""
        }
...
public extension CGFloat {
    ...
    /**
     ...
     - returns:
     */
    func kr_toString(_ minF: Int = 2, maxF: Int = 6, minI: Int = 1) -> String {
...
public extension Array where Element: Equatable {
    ...
    mutating func kr_removeObject(_ object: Element) {
        if let index = self.firstIndex(of: object) {
            self.remove(at: index)
        }
    }
    
    mutating func kr_removeObjectsInArray(_ array: [Element]) {
        for object in array {
            self.kr_removeObject(object)
        }
    }
}
