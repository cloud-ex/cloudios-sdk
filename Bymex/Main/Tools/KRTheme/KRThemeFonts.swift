...
extension UIFont {
    public struct ThemeFont {
        ...
        public static var H2Regular :UIFont { return UIFont.systemFont(ofSize: 24, weight:.regular)}
        public static var H3Bold :UIFont { return UIFont.systemFont(ofSize: 18, weight:.bold)}
        public static var H3Medium :UIFont { return UIFont.systemFont(ofSize: 17, weight:.medium)}
