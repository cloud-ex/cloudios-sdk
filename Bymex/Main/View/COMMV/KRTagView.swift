...
//  Bymex
//
//  Created by KarlLichterVonRandoll on 2020/4/13.
//  Copyright © 2020 KarlLichterVonRandoll. All rights reserved.
//

import UIKit

class KRTagView: UIButton {
    
    static func commonTagView() -> KRTagView {
        let view = KRTagView.init(title: "")
        view.paddingX = 2
...
//        view.titleEdgeInsets = UIEdgeInsets(top: 0, left: 4, bottom: 0, right: 4)
    ...
    open var onTap: ((KRTagView) -> Void)?
    open var onLongPress: ((KRTagView) -> Void)?
